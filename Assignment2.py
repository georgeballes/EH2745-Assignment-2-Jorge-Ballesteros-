...
# high_load_data_source = create_data_source(100, Load5_Pd_MW, Load7_Pd_MW, Load9_Pd_MW, Load5_Qd_MVAR,
#                                            Load7_Qd_MVAR, Load9_Qd_MVAR, 'High Load')

# low_load_data_source = create_data_source(100, Load5_Pd_MW, Load7_Pd_MW, Load9_Pd_MW, Load5_Qd_MVAR,
#                                            Load7_Qd_MVAR, Load9_Qd_MVAR, 'Low Load')

# print (high_load_data_source)
# print (low_load_data_source)
# # print(simple_test_net())
